...
namespace CapaWeb.Formularios.Cargo
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (!CapaProceso.Clases.Menucargo.ExisteMenu("Cargo", int.Parse(Session["idCargo"].ToString())))
                {
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Cargo.Lista();
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Cargo.Buscar(TxtBuscar.Text);

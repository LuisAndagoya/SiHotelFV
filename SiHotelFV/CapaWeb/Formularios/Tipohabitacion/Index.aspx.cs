...
namespace CapaWeb.Formularios.Tipohabitacion
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (!CapaProceso.Clases.Menucargo.ExisteMenu("Tipo H.", int.Parse(Session["idCargo"].ToString())))
                {
        ...
        {
            Grid.DataSource = CapaProceso.Clases.TipoHabitacion.Lista();
        ...
        {
            Grid.DataSource = CapaProceso.Clases.TipoHabitacion.Buscar(TxtBuscar.Text);

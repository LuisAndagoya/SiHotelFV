...
namespace CapaWeb.Formularios.Hotel
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (!CapaProceso.Clases.Menucargo.ExisteMenu("Hotel", int.Parse(Session["idCargo"].ToString())))
                {
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Hotel.Lista();
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Hotel.Buscar(TxtBuscar.Text);

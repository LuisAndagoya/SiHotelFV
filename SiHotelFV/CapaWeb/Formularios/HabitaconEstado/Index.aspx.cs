...
namespace CapaWeb.Formularios.HabitaconEstado
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        {
            Grid.DataSource = CapaProceso.Clases.HabitacionEstado.Lista();
        ...
        {
            Grid.DataSource = CapaProceso.Clases.HabitacionEstado.Buscar(TxtBuscar.Text);

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="CapaWeb.Formularios.HabitaconEstado.Index" %>
                                    ...
                                    <asp:DataGrid ID="Grid" runat="server" onrowcreated="GriTipoUsuario_RowCreated"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="id" Visible="False">
                                                <ItemTemplate>
                                                    <span style="float: left;">
                                                        <asp:Label ID="lblId" runat="server" Text='<%#Eval("idHabitacion_Estado") %>'></asp:Label>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <asp:TemplateColumn HeaderText="Hotel">
                                                <ItemTemplate>
                                                    <span style="float: left;">
                                                        <asp:Label ID="Estado" runat="server" Text='<%#Eval("NombreEstado") %>'></asp:Label>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>

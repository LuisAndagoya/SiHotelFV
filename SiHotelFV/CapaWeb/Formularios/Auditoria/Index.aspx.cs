...
namespace CapaWeb.Formularios.Auditoria
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Auditoria.Lista();
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Auditoria.Buscar(TxtBuscar.Text);

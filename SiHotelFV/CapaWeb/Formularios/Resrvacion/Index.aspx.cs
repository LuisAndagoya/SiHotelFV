...
namespace CapaWeb.Formularios.Resrvacion
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Reservacion.Lista();
        ...
        {
            Grid.DataSource = CapaProceso.Clases.Reservacion.Buscar(TxtBuscar.Text);

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReservaUsuario.aspx.cs" Inherits="CapaWeb.Reportes.ReservaUsuario" %>
     ...
     <form id="form1" class="forms-sample" runat="server">
        ...
        <asp:ImageButton ID="imgEliminar" runat="server" OnClick="imgEliminar_Click"
         ...
         <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="500px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
             <LocalReport ReportPath="Reportes\ReservaUsuario.rdlc">
                 <DataSources>
         ...
         <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="Usuario" TypeName="CapaDatos.Clases.ReporteReservaTableAdapters.reservasTableAdapter" UpdateMethod="Update">
             <DeleteParameters>

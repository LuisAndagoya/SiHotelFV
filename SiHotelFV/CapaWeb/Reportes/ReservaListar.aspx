<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReservaListar.aspx.cs" Inherits="CapaWeb.Reportes.ReservaListar" %>
     ...
     <form id="form1" class="forms-sample" runat="server">
        ...
        <asp:ScriptManager runat="server"></asp:ScriptManager>
         ...
         <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="500px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
             <LocalReport ReportPath="Reportes\NuevoReporte.rdlc">
                 <DataSources>
                     <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSetListar" />
                 </DataSources>
             </LocalReport>
         </rsweb:ReportViewer>


         <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="Numero" TypeName="CapaDatos.Clases.DetalleReservaTableAdapters.detalle_reservaTableAdapter" UpdateMethod="Update">
             <DeleteParameters>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReservaFac.aspx.cs" Inherits="CapaWeb.Reportes.ReservaFac" %>
      ...
      <form id="form1" class="forms-sample" runat="server">
        ...
        <asp:ScriptManager runat="server"></asp:ScriptManager>
          <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="500px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
              <LocalReport ReportPath="Reportes\ReservaFac.rdlc">
                  <DataSources>
                      <rsweb:ReportDataSource DataSourceId="ObjectDataSource3" Name="DataSetCabecera" />
                  </DataSources>
              </LocalReport>
          </rsweb:ReportViewer>
          <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetFactura" TypeName="CapaDatos.Clases.ReservaTableAdapters.reservasTableAdapter" UpdateMethod="Update">
              <DeleteParameters>
              ...
              <SelectParameters>
                  <asp:Parameter DefaultValue="Id" Name="idReservacion" Type="Int32" />
              </SelectParameters>
              <UpdateParameters>
                  <asp:Parameter Name="idCliente" Type="Int32" />
                  <asp:Parameter Name="idUsuario" Type="Int32" />

...
SELECT idAuditoria, ipAuditoria, tablaAuditoria, accionAditoria, idEmpleado, fechaAditoria FROM auditoria WHERE (idAuditoria = @idAuditoria)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT        auditoria.ipAuditoria, auditoria.tablaAuditoria, auditoria.accionAditoria, auditoria.idEmpleado, auditoria.fechaAditoria, auditoria.idAuditoria, usuario.usernameUsuario
FROM            usuario INNER JOIN
                         auditoria ON auditoria.idEmpleado = usuario.idEmplado";

...
namespace CapaDatos.Clases {
    ...
    public partial class Cliente : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClienteRow AddClienteRow(string CedulaCliente, string NombreCliente, string ApellidoCliente, string DireccionCliente, string Telefono, string Email) {
            ...
            private void InitClass() {
                ...
                this.columnCedulaCliente.MaxLength = 10;
...
namespace CapaDatos.Clases.ClienteTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([CedulaCliente], [NombreCliente], [ApellidoCliente]," +
                " [DireccionCliente], [Telefono], [Email]) VALUES (@CedulaCliente, @NombreCliente" +
                ", @ApellidoCliente, @DireccionCliente, @Telefono, @Email)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idCliente, CedulaCliente, NombreCliente, ApellidoCliente, DireccionCliente" +
                ", Telefono, Email FROM dbo.Cliente";
            ...
            this._commandCollection[2].CommandText = @"SELECT        idCliente, CedulaCliente, NombreCliente, ApellidoCliente, DireccionCliente, Telefono, Email
FROM            Cliente
WHERE        (CedulaCliente LIKE @CedulaCliente) OR
                         (NombreCliente LIKE @NombreCliente) OR
                         (ApellidoCliente LIKE @ApellidoCliente)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CedulaCliente", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "CedulaCliente", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3].CommandText = "SELECT        idCliente, CedulaCliente, NombreCliente, ApellidoCliente, Direccion" +
                "Cliente, Telefono, Email\r\nFROM            Cliente";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT idCliente, CedulaCliente, NombreCliente, ApellidoCliente, DireccionCliente" +
            ...
            this._commandCollection[5].CommandText = "INSERT INTO [dbo].[Cliente] ([CedulaCliente], [NombreCliente], [ApellidoCliente]," +
                " [DireccionCliente], [Telefono], [Email]) VALUES (@CedulaCliente, @NombreCliente" +
                ", @ApellidoCliente, @DireccionCliente, @Telefono, @Email)";
            this._commandCollection[5].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[5].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CedulaCliente", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "CedulaCliente", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[6].CommandText = "SELECT COUNT(CedulaCliente)  AS Expr1 FROM Cliente\r\nWHERE        (CedulaCliente =" +
                " @CedulaCliente)\r\n";
            this._commandCollection[6].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CedulaCliente", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "CedulaCliente", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[7] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[7].Connection = this.Connection;
            this._commandCollection[7].CommandText = @"UPDATE       Cliente
SET                CedulaCliente = @CedulaCliente, NombreCliente = @NombreCliente, ApellidoCliente = @ApellidoCliente, DireccionCliente = @DireccionCliente, Telefono = @Telefono, Email = @Email
WHERE        (idCliente = @idCliente); 
SELECT idCliente, CedulaCliente, NombreCliente, ApellidoCliente,DireccionCliente,  Telefono, Email
  FROM Cliente WHERE (idCliente = @idCliente)
";
            this._commandCollection[7].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[7].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CedulaCliente", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "CedulaCliente", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual Cliente.ClienteDataTable GetBuscar(string CedulaCliente, string NombreCliente, string ApellidoCliente) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((CedulaCliente == null)) {
                throw new global::System.ArgumentNullException("CedulaCliente");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(CedulaCliente));
            }
        ...
        public virtual int Insert(string CedulaCliente, string NombreCliente, string ApellidoCliente, string DireccionCliente, string Telefono, string Email) {
            if ((CedulaCliente == null)) {
                throw new global::System.ArgumentNullException("CedulaCliente");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(CedulaCliente));
            }
            if ((NombreCliente == null)) {
                throw new global::System.ArgumentNullException("NombreCliente");
            }
        ...
        public virtual int InsertQuery(string CedulaCliente, string NombreCliente, string ApellidoCliente, string DireccionCliente, string Telefono, string Email) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[5];
            if ((CedulaCliente == null)) {
                throw new global::System.ArgumentNullException("CedulaCliente");
            }
            else {
                command.Parameters[0].Value = ((string)(CedulaCliente));
            }
            if ((NombreCliente == null)) {
                throw new global::System.ArgumentNullException("NombreCliente");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> unico(string CedulaCliente) {
        ...
        public virtual int UpdateQuery(string CedulaCliente, string NombreCliente, string ApellidoCliente, string DireccionCliente, string Telefono, string Email, int idCliente) {
            ...
            command.Parameters[6].Value = ((int)(idCliente));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();

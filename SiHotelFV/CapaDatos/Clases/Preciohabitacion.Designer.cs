...
SELECT idPrecio, precioHabitacion, fechaPrecio, estadoPrecio FROM precio_habitacion WHERE (idPrecio = @idPrecio)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM [dbo].[precio_habitacion] WHERE (([idPrecio] = @idPrecio))";
...
SELECT idPrecio, precioHabitacion, fechaPrecio, estadoPrecio FROM precio_habitacion WHERE (idPrecio = @idPrecio)";
        ...
        public virtual int DeleteQuery(int idPrecio) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(idPrecio));
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> unico(double precioHabitacion) {
